...
import { SuggestionRegistry } from './suggestion_registry';
import { ChatContext, ISuggestionProvider, SuggestionServiceContract } from './types';

/**
 * Service for managing custom suggestion providers and retrieving suggestions
 */
export class SuggestionService implements SuggestionServiceContract {
  private registry: SuggestionRegistry;
  private isInitialized = false;

  constructor() {
    this.registry = new SuggestionRegistry();
  }
