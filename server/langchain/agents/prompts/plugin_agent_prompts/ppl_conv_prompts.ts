...
// export const PPL_AGENT_SYSTEM_MESSAGE = `Assistant is a large language model trained by Anthropic and prompt-tuned by OpenSearch.

// Assistant is designed to be able to assist with a wide range of tasks, from answering simple questions to providing in-depth explanations and discussions on a wide range of topics. As a language model,
